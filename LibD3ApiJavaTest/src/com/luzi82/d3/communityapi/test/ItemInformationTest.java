...
public class ItemInformationTest {
	...
	public void test_000() throws JsonParseException, JsonMappingException, IOException {
		...
		Assert.assertEquals(70f, ii.attributesRaw.Item_LegendaryItem_Level_Override.min, 0.0001);
		Assert.assertEquals(70f, ii.attributesRaw.Item_LegendaryItem_Level_Override.max, 0.0001);
		Assert.assertEquals(408f, ii.attributesRaw.Durability_Max.min, 0.0001);
		Assert.assertEquals(408f, ii.attributesRaw.Durability_Max.max, 0.0001);
		Assert.assertEquals(23f, ii.attributesRaw.Damage_Delta_Physical.min, 0.0001);
		Assert.assertEquals(23f, ii.attributesRaw.Damage_Delta_Physical.max, 0.0001);
		...
		Assert.assertEquals(1905181658f, ii.attributesRaw.Item_Legendary_Item_Base_Item.min, 0.0001);
		Assert.assertEquals(1905181658f, ii.attributesRaw.Item_Legendary_Item_Base_Item.max, 0.0001);
		Assert.assertEquals(0f, ii.attributesRaw.Season.min, 0.0001);
		Assert.assertEquals(0f, ii.attributesRaw.Season.max, 0.0001);
		Assert.assertEquals(689f, ii.attributesRaw.Vitality_Item.min, 0.0001);
		Assert.assertEquals(689f, ii.attributesRaw.Vitality_Item.max, 0.0001);
		Assert.assertEquals(20181f, ii.attributesRaw.Health_Globe_Bonus_Health.min, 0.0001);
		Assert.assertEquals(20181f, ii.attributesRaw.Health_Globe_Bonus_Health.max, 0.0001);
		Assert.assertEquals(408f, ii.attributesRaw.Durability_Max_Before_Reforge.min, 0.0001);
		Assert.assertEquals(408f, ii.attributesRaw.Durability_Max_Before_Reforge.max, 0.0001);
		Assert.assertEquals(214f, ii.attributesRaw.Durability_Cur.min, 0.0001);
		Assert.assertEquals(214f, ii.attributesRaw.Durability_Cur.max, 0.0001);
		Assert.assertEquals(14f, ii.attributesRaw.Resource_Max_Bonus_Arcanum.min, 0.0001);
		Assert.assertEquals(14f, ii.attributesRaw.Resource_Max_Bonus_Arcanum.max, 0.0001);
		...
		Assert.assertEquals(2f, ii.attributesRaw.Item_Binding_Level_Override.min, 0.0001);
		Assert.assertEquals(2f, ii.attributesRaw.Item_Binding_Level_Override.max, 0.0001);
		Assert.assertEquals(99f, ii.attributesRaw.Damage_Min_Physical.min, 0.0001);
		Assert.assertEquals(99f, ii.attributesRaw.Damage_Min_Physical.max, 0.0001);
		Assert.assertEquals(666f, ii.attributesRaw.Intelligence_Item.min, 0.0001);
		Assert.assertEquals(666f, ii.attributesRaw.Intelligence_Item.max, 0.0001);
	...
	public void test_020() throws JsonParseException, JsonMappingException, IOException {
		ItemInformation ii = IO.readItemInformation("sample/iteminformation_020.json");

		Assert.assertEquals(0.97f, ii.attributesRaw.Item_Power_Passive_ItemPassive_Unique_Ring_526_x1.min, 0.000001f);
		Assert.assertEquals(0.97f, ii.attributesRaw.Item_Power_Passive_ItemPassive_Unique_Ring_526_x1.max, 0.000001f);
	}

	@Test
	public void test_021() throws JsonParseException, JsonMappingException, IOException {
		ItemInformation ii = IO.readItemInformation("sample/iteminformation_021.json");

		Assert.assertEquals(0.1f, ii.attributesRaw.Power_Damage_Percent_Bonus_Trait_Witchdoctor_ZombieDogSpawner_Passive.min, 0.000001f);
		Assert.assertEquals(0.1f, ii.attributesRaw.Power_Damage_Percent_Bonus_Trait_Witchdoctor_ZombieDogSpawner_Passive.max, 0.000001f);

		Assert.assertEquals(155f, ii.attributesRaw.Resistance_Poison.min, 0.000001f);
		Assert.assertEquals(155f, ii.attributesRaw.Resistance_Poison.max, 0.000001f);
	}
